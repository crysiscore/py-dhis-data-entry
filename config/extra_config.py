...
'magoanine_tenda_psa','magoanine_ps','zimpeto_ps','inhaca_ps','catembe_cs','chamissava_cs','incassane_cs','mutsekwa_ps','centro_de_saude_do_chamanculo_cs',
'chamanculo_hg','jose_macamo_cs','jose_macamo_HG','xipamanine_csurb']
forms = ['C&T_Resumo de Cuidados e Tratamento','PTV-Resumo Mensal de PTV','C&T_Relatorio de Retencao e Modelos Diferenciados de Saude','ATS-Resumo Mensal de Aconselhamento e Testagem em Saude']
